// Package main is the entry point for the KRAKER X-UI web panel application.
...
import (
	...
	"github.com/underkraker/kraker-iu/sub"
	"github.com/underkraker/kraker-iu/util/crypto"
	"github.com/underkraker/kraker-iu/util/sys"
	"github.com/underkraker/kraker-iu/web"
	"github.com/underkraker/kraker-iu/web/global"
...
// runWebServer initializes and starts the web server for the KRAKER X-UI panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the KRAKER X-UI panel.
func migrateDb() {
...
// main is the entry point of the KRAKER X-UI application.
