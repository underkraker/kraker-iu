// Package entity defines data structures and entities used by the web layer of the KRAKER X-UI panel.
package entity
...
// AllSetting contains all configuration settings for the KRAKER X-UI panel including web server, Telegram bot, and subscription settings.
